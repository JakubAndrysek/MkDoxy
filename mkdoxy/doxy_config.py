...
# Configuration options for the plugin - legacy type option
config_scheme = (
    ("projects", c.Type(dict, default=None, required=True)),
    ("full-doc", c.Type(bool, default=None, required=False)),  # legacy option
...
# Config options for each project - legacy type options
project_config_scheme = (
    ("src-dirs", c.Type(str, default=None, required=False)),  # legacy option
    ("src_dirs", c.Type(str, default=None, required=False)),
    ("full-doc", c.Type(bool, default=None, required=False)),  # legacy option
    ("full_doc", c.Type(bool, default=True, required=False)),
    ("debug", c.Type(bool, default=False)),
    ("ignore-errors", c.Type(bool, default=None, required=False)),  # legacy option
    ("ignore_errors", c.Type(bool, default=False)),
    ("doxy-cfg", c.Type(dict, default=None, required=False)),  # legacy option
    ("doxy_config_dict", c.Type(dict, default={}, required=False)),
    ("doxy-cfg-file", c.Type(str, default=None, required=False)),  # legacy option
    ("doxy_config_file", c.Type(Path, default=None, required=False)),
    ("template-dir", c.Type(str, default=None, required=False)),  # legacy option
    ("custom_template_dir", c.Type(str, default=None, required=False)),
)
