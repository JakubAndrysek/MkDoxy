...
class Finder:
    ...
    def _doxy_parent(self, project: str, parent: str, kind: Kind) -> list[str] | None:
    ...
    def doxy_class_method(self, project: str, class_name: str, method_name: str) -> list[str] | None:
        return self._doxy_member_in_parent(project, class_name, Kind.CLASS, method_name, Kind.FUNCTION)

    def doxy_namespace_function(self, project: str, namespace: str, function_name: str) -> list[str] | None:
        return self._doxy_member_in_parent(project, namespace, Kind.NAMESPACE, function_name, Kind.FUNCTION)

    def doxy_function(self, project: str, function_name: str) -> list[str] | None:
