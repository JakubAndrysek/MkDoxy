...
class DoxygenRun:
	def __init__(self, sourceDir, destinationDir):
		...
		self.command = f'/media/kuba/neon/git/robo/rbcx-robotka/mkdocs-doxygen-snippets-plugin/master/doxygen_snippets/extractDoxygen.sh "Doxygn Snippets" {self.sourceDir} {self.destinationDir}'
	...
	def getDestination(self):
		return os.path.join(self.destinationDir, "xml")
